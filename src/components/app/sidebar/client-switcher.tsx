// components/app/sidebar/client-switcher.tsx
'use client'
...
export function ClientSwitcher({ clients, defaultClient }: ClientSwitcherProps) {
  const { isMobile } = useSidebar()
  const [selectedClient, setSelectedClient] = useState<Client | undefined>(defaultClient)
